...
namespace GeziBlogum.Migrations
{
    ...
    [Migration("20250415135559_AddCommentVoteTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeziBlogum.Entity.Comment", b =>
                {
            ...
            modelBuilder.Entity("GeziBlogum.Entity.Tag", b =>
                {
            ...
            modelBuilder.Entity("GeziBlogum.Entity.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GeziBlogum.Entity.Comment", b =>
                {
                    b.HasOne("GeziBlogum.Entity.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("GeziBlogum.Entity.Post", null)
                        .WithMany()
                        .HasForeignKey("PostsPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GeziBlogum.Entity.Tag", null)
                        .WithMany()
